    ...
    <div className="flex items-center gap-1 mt-1">
      ...
      {hasImage && (
        <button
          ...
          style={{ background: '#3a1a1a', color: '#e05252' }}
        >
          ✕
        </button>
      )}
    ...
    <div className="min-h-screen" style={{ background: '#1f1f1e', color: '#e8e6e1' }}>
      <header style={{ background: '#2a2a28', borderBottom: '1px solid #3a3a38' }}
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button onClick={deleteDeck} className="text-xs sm:text-sm transition-colors"
            style={{ color: '#8a4040' }}>
            Удалить
          </button>
        </div>
                ...
                <div className="flex gap-4 items-start">
                  <div className="flex-1 min-w-0">
                    <div className="mb-3">
                      ...
                      <ImageUploadButton cardId={card.id} side="front" hasImage={!!card.front_image} onDone={fetchDeck} />
                    </div>
                    <div style={{ borderTop: '1px solid #3a3a38', paddingTop: '10px' }}>
                      ...
                      <ImageUploadButton cardId={card.id} side="back" hasImage={!!card.back_image} onDone={fetchDeck} />
                    </div>
                  </div>
                  <button
